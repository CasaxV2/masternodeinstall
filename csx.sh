...
CONFIG_FILE='Casax.conf'
CONFIGFOLDER='/root/.Casax'
COIN_DAEMON='/usr/local/bin/Casaxd'
COIN_CLI='/usr/local/bin/Casax-cli'
COIN_REPO='https://github.com/CaSaX/casax-core/releases/download/1.0.5/Casax-1.0.5-x86_64-linux-gnu.tar.gz'
COIN_NAME='Casax'
COIN_PORT=9116
